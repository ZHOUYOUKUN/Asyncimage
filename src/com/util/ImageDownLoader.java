...
import com.interfaces.onImageLoaderListener;
...
public class ImageDownLoader {
	 ...
	 */
	private LinkedHashMap<String, SoftReference<Bitmap>> softreferences=new LinkedHashMap<String, SoftReference<Bitmap>>(40, 0.75f, true);
	...
	public ImageDownLoader(Context context){
		...
		mMemoryCache = new LruCache<String, Bitmap>(mCacheSize){
			...
			protected void entryRemoved(boolean evicted, String key,
				...
				softreferences.put(key, new SoftReference<Bitmap>(oldValue));
			}
		};
	...
	public synchronized void addBitmapToMemoryCache(String key, Bitmap bitmap) { 
		if (getBitmapFromMemCache(key) == null && bitmap != null) {  
			...
			//考虑到3.1(API Level=12)一下版本不支持lurcache，就加入软应用
			if(getSDKVersionNumber()<12)
	...
	public Bitmap downloadImage(final String url, final onImageLoaderListener listener){
		...
		//如果缓存，软应用，或者sd中有就直接返回bitmap，否则就网络请求
		if(bitmap != null){
			return bitmap;
		}else{
